...
<ol class="bl">
	<li>How open the runtime is: some are fully open source, while others let you view the source code but restrict how it can be used, modified, or commercialized.</li>
